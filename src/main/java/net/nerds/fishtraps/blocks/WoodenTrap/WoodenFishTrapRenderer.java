...
public class WoodenFishTrapRenderer implements BlockEntityRenderer<WoodenFishTrapTileEntity, WoodenFishTrapRenderer.RenderState> {
    ...
    @Override
    public void extractRenderState(WoodenFishTrapTileEntity tile, RenderState renderState, float partialTick,
                                   Vec3 cameraPos,
    ...
    public static class RenderState extends BlockEntityRenderState {
        ...
        public WoodenFishTrapTileEntity tile;
    }
}