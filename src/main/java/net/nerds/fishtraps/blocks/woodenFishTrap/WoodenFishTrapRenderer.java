...
public class WoodenFishTrapRenderer implements BlockEntityRenderer<WoodenFishTrapBlockEntity, WoodenFishTrapRenderer.RenderState> {
    ...
    @Override
    public void extractRenderState(WoodenFishTrapBlockEntity tile, RenderState renderState, float partialTick,
                                   Vec3 cameraPos,
