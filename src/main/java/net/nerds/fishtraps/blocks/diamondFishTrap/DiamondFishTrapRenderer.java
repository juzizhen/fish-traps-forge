...
public class DiamondFishTrapRenderer implements BlockEntityRenderer<DiamondFishTrapBlockEntity, DiamondFishTrapRenderer.RenderState> {
    ...
    @Override
    public void extractRenderState(DiamondFishTrapBlockEntity tile, RenderState renderState, float partialTick,
                                   Vec3 cameraPos,
