...
@OnlyIn(Dist.CLIENT)
public class IronFishTrapRenderer implements BlockEntityRenderer<IronFishTrapTileEntity> {
    ...
    @Override
    public void render(IronFishTrapTileEntity tile, float partialTicks, PoseStack poseStack,
