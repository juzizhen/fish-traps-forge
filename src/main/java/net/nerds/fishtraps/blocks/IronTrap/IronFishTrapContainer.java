...
public class IronFishTrapContainer extends AbstractContainerMenu {

    private final BlockPos trapPos;

    public IronFishTrapContainer(int containerId, Inventory playerInv, FishTrapItemHandler handler,
