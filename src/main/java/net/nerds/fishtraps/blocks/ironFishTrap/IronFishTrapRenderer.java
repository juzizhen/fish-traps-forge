...
public class IronFishTrapRenderer implements BlockEntityRenderer<IronFishTrapBlockEntity, IronFishTrapRenderer.RenderState> {
    ...
    @Override
    public void extractRenderState(IronFishTrapBlockEntity tile, RenderState renderState, float partialTick,
                                   Vec3 cameraPos,
