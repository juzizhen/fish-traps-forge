...
public class FishTrapsConfig {
    ...
    public static IntValue woodenTrapLuckLevel = null;
    public static IntValue woodenTrapBaseTime = null;
    public static IntValue ironTrapLureLevel = null;
    public static IntValue ironTrapLuckLevel = null;
    public static IntValue ironTrapBaseTime = null;
    public static IntValue diamondTrapLureLevel = null;
    public static IntValue diamondTrapLuckLevel = null;
    public static IntValue diamondTrapBaseTime = null;
    public static IntValue trapPenaltyMultiplier = null;
